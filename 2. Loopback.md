...
Flow Navigator에서 Generate Bitstream을 클릭하여 Bitstream을 생성한다.
...
1. File - Export - Export Harware를 클릭한다. 이어서 나타나는 창에서 Include bitstream옵션을 선택하고 OK를 누른다.

2. File - Launch SDK를 클릭하고 기다리면 Vivado SDK가 실행된다.
